...
const PRODUCTS = [
  // Electronics (13 products)
  {
    ...
    description:
      "Premium noise-canceling wireless earbuds with 24hr battery life",
  ...
  },
  {
    ...
    description: "Multi-port hub with HDMI, USB-A, SD card slots",
    category: "electronics",
    price: 49.99,
    stock: 32,
  },
  ...
  },
  {
    ...
    description: "Aluminum adjustable phone and tablet stand",
    category: "electronics",
    price: 24.99,
    stock: 120,
  },
  ...
  },
  {
    ...
    description: "Padded laptop sleeve with accessory pocket",
    category: "electronics",
    price: 34.99,
    stock: 78,
  },
  ...
  },
  {
    ...
    description: "Classic slim fit denim jeans in dark wash",
    category: "clothing",
    price: 59.99,
    stock: 65,
  },
  {
    ...
    description: "Soft fleece pullover hoodie with kangaroo pocket",
    category: "clothing",
    price: 44.99,
    stock: 88,
  },
  ...
  },
  {
    ...
    description: "Classic oxford dress shirt, wrinkle-resistant",
    category: "clothing",
    price: 49.99,
    stock: 36,
  },
  {
    name: "Yoga Pants",
    description: "High-waist yoga pants with side pocket",
    category: "clothing",
    price: 39.99,
    stock: 92,
  },
  ...
  {
    name: "Shower Curtain",
    description: "Waterproof fabric shower curtain with hooks",
    category: "home",
    price: 22.99,
    stock: 38,
  },
  {
    ...
    description: "Set of 6 foldable fabric storage bins",
    category: "home",
    price: 34.99,
    stock: 71,
  },
  {
    ...
    description: "12-inch silent wall clock, minimalist design",
    category: "home",
    price: 29.99,
    stock: 4,
  },
  {
    ...
    description: "Set of 3 soy wax scented candles",
    category: "home",
    price: 24.99,
    stock: 96,
  },
  {
    name: "Bathroom Mat",
    description: "Memory foam bathroom mat, non-slip",
    category: "home",
    price: 19.99,
    stock: 83,
  },
  {
    ...
    description: "6-inch ceramic plant pot with drainage",
    category: "home",
    price: 16.99,
    stock: 112,
  },
  ...
  {
    name: "Dumbbells Set 20lb",
    description: "Pair of 20lb rubber hex dumbbells",
    category: "sports",
    price: 59.99,
    stock: 31,
  },
  ...
  },
  {
    ...
    description: "Match quality soccer ball, FIFA approved",
    category: "sports",
    price: 29.99,
    stock: 44,
  },
  ...
  {
    name: "Gym Bag Duffel",
    description: "Large duffel bag with shoe compartment",
    category: "sports",
    price: 44.99,
    stock: 52,
  },
