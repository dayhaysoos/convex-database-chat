      ...
      <div className="relative flex-1">
        ...
        <div className="mx-auto w-full max-w-6xl px-6 pb-10 pt-16 sm:pt-20">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-center">
            ...
            <div className="relative hidden animate-rise animate-rise-delay-2 lg:block">
              <div
                className="pointer-events-none absolute -inset-6 rounded-[36px] bg-fd-accent opacity-30 blur-3xl"
                aria-hidden="true"
              />
              <div className="relative rounded-3xl border border-fd-border bg-fd-card p-4 shadow-sm sm:p-6">
                <img
                  src="/database-chat.webp"
                  alt="DatabaseChat logo"
        ...
        <div className="mx-auto w-full max-w-6xl px-6 pb-12">
          <h2 className="text-2xl font-semibold text-fd-foreground sm:text-3xl animate-rise animate-rise-delay-1">
